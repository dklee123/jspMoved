                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                                        ...
                                        <thead>
                                         ...
                                         <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="../boardAdmin/mngBbsRead.jsp?no=<%=eachvo.getNo()%>"><%= eachvo.getSubject() %></td>
                            ...
                            <button type="button" class="btn btn-primary" onclick="location.href='mngBbsWrite.html'">글등록</button>
