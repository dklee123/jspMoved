                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card spur-card">
                                ...
                                <div class="card-body ">
                                    <form action="mngBbsWrtPro.jsp" method="POST" enctype="multipart/form-data">
...
<!--                                             <button type="button" class="btn btn-primary">파일삭제</button> -->
                                        ...
                                        <button type="button" class="btn btn-primary" onclick="location.href='../../boardAdmin/mngBoard.jsp'">목록</button>
                                    </form>
                                </div>
                            </div>
    ...
    <script>
    	function del_bbs(tempno){
    		...
    		if(ok==true){
    			alert(tempno);
//     			location.href = '../../boardAdmin/mngBbsDel.jsp?no='+tempno;
    		}else{
    			alert('삭제 취소 되었습니다.');
    		}
    	}
